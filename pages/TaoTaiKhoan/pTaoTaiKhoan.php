...
<form style="width:10%"action="pages/TaoTaiKhoan/xlTaoTaiKhoan.php" method="post" onsubmit="return KiemTra()" class="form" style="width:300px; border:1px solid green; padding:20px; margin:0 auto; font-weight:700px;">
	<div>
